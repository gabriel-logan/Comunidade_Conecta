...
export default function JurosSimples() {
  const escolheJuroSimples = () => {
    const simplesEscolhe = document.querySelector('#simples_escolhe-calc');
    const juroSimples = document.querySelector('.calc_juros_simples');
    const capitalInicial = document.querySelector('.calc_capital_inicial');
    const taxaDeJuros = document.querySelector('.calc_taxa_juros');
  ...
  const calculaTaxaDeJuros = (e) => {
    ...
    const calculoTJuros = (Number(taxaJurosJuros) / ((Number(taxaCapital)) * Number(taxaTempo))) * 100;
    if (errors) return;
      ...
      <div className="calc_capital_inicial off">
        <form onSubmit={calculaCapitalInicial}>
          <label htmlFor="none">
            ...
            <input placeholder="Ex: 4,2" value={jurosCapital} onChange={(e) => { setJurosCapital(e.target.value); }} />
      ...
      <div className="calc_taxa_juros off">
        <form onSubmit={calculaTaxaDeJuros}>
          <label htmlFor="none">
            ...
            <input placeholder="Ex: 50" value={taxaCapital} onChange={(e) => { setTaxaCapital(e.target.value); }} />
          ...
          <label htmlFor="none">
            ...
            <input
              ...
              onChange={(e) => { setTaxaJurosJuros(e.target.value); }}
            />
